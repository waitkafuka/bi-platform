...
public class MeasureCondition implements MetaCondition {
    ...
    /**
     * measureConditions 指标条件，如 [Measure].[csm] > 1000; [Measure].[csm] / [Measure].[cash] > 1
     */
    private List<String> measureConditions;
     ...
     */
    public List<String> getMeasureConditions() {
     ...
     */
    public void setMeasureConditions(List<String> measureConditions) {
