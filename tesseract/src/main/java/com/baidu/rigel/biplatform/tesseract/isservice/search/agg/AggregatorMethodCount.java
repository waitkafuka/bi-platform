...
/**
 * 
 * AggregatorMethodCount 聚合-count
 * 
 * @author lijin
 *
 */
public class AggregatorMethodCount extends AggregatorMethod {
    /**
     * INSTANCE
     */
    ...
    public synchronized static AggregatorMethod getAggregatorMethodInstance() {
        if (INSTANCE == null) {
            INSTANCE = new AggregatorMethodCount();
        }
        return INSTANCE;
    }
