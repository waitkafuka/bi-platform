 ...
 *
 */
public class PaloDataSourceInfo implements DataSourceInfo {
     ...
     * dataBase 数据库类型
     */
    private DataBase dataBase = DataBase.PALO;
     ...
     * dataSourceType 类型
     */
    private DataSourceType dataSourceType = DataSourceType.PALO;
     ...
     */
    public PaloDataSourceInfo(String dataSourceKey) {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((dataSourceKey == null) ? 0 : dataSourceKey.hashCode());
		result = prime * result
				+ ((dataSourceType == null) ? 0 : dataSourceType.hashCode());
		result = prime * result
				+ ((dbPoolInfo == null) ? 0 : dbPoolInfo.hashCode());
		result = prime * result
		...
		result = prime * result
				+ ((jdbcUrls == null) ? 0 : jdbcUrls.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PaloDataSourceInfo other = (PaloDataSourceInfo) obj;
