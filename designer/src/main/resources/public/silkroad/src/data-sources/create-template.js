...
define(['template'], function (template){
    ...
    var html = '<!--模板-添加数据源-->'
        ...
        +             '<option value="MYSQL" {{if ds&&ds.type== "MYSQL"}} selected="true"{{/if}}>MySQL</option>'
        +             '<option value="MYSQL-DBPROXY" {{if ds&&ds.type== "MYSQL-DBPROXY"}} selected="true"{{/if}}>MySQL-DBPROXY</option>'
        +             '<option value="HIVE" {{if ds&&ds.type== "HIVE"}} selected="true"{{/if}}>HIVE</option>'
        +         '<select>'
        +     '</div>'
        +     '<div class="form-common-line">'
