...
class UpdateContextQueryTransHandler extends QueryRequestTransHandler {
    
    public UpdateContextQueryTransHandler() {
    ...
    boolean isSupportedQueryStrategy(QueryStrategy queryStrategy) {
        return QueryStrategy.CONTEXT_UPDATE == queryStrategy;
    }
