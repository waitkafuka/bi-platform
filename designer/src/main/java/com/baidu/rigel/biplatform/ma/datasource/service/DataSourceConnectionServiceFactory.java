...
import com.baidu.rigel.biplatform.ma.datasource.service.impl.RelationDBConnectionServiceImpl;
...
public class DataSourceConnectionServiceFactory {
	 ...
	 */
	public static DataSourceConnectionService<?> getDataSourceConnectionServiceInstance(DataSourceType sourceType)
