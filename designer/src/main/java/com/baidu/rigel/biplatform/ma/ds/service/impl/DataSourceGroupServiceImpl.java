...
public class DataSourceGroupServiceImpl implements DataSourceGroupService {
	 ...
	 */
	@Override
	public DataSourceGroupDefine saveOrUpdateDataSourceGroup(
			DataSourceGroupDefine dsG, String securityKey)
        ...
        try {
            ...
            if (oldDsG != null && !oldDsG.getName().equals(dsG.getName())) { // 修改了数据源名称
            ...
            String fileName = DataSourceUtil.getDsGroupFileName(dsG);
            ...
            if (oldDsFileName == null || rmOperResult) { // 删除操作成功
                fileService.write(fileName, SerializationUtils.serialize(dsG));
            }
        } catch (Exception e) {
            // 如果发生异常 考虑回滚或者其他容错操作
	 ...
	 */
	private void checkDataSourceGroupDefine(DataSourceGroupDefine dsG, String securityKey) throws DataSourceOperationException {
		if (dsG == null) {
	 ...
	 */
	@Override
	public boolean removeDataSourceGroup(String id)
			throws DataSourceOperationException {
	 ...
	 */
	@Override
	public DataSourceGroupDefine[] listAll()
			throws DataSourceOperationException {
	 ...
	 */
	@Override
	public DataSourceGroupDefine getDataSourceGroupDefine(String id)
			throws DataSourceOperationException {
	 ...
	 */
	@Override
	public DataSourceGroupDefine getDataSourceGroupDefine(String productLine,
			String name) throws DataSourceOperationException {
	...
	private DataSourceGroupDefine readDsGroupDefineFromFile(String fileName) throws FileServiceException {
		byte[] content = (byte[]) fileService.read(DataSourceUtil.getDsGroupFileName(fileName));
...
//			ds.setId(UuidGeneratorUtils.generate());
	 ...
	 */
	@Override
	public DataSourceDefine getDataSourceDefine(String id, String subId)
			throws DataSourceOperationException {
		// 获取数据源组定义
		DataSourceGroupDefine dsG = this.getDataSourceGroupDefine(id);
		if (dsG == null) {
