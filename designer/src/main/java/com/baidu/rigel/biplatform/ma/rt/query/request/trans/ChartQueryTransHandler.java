...
/**
 * 
 * ChartQueryTransHandler
 * @author wangyuxue
 * @version 1.0.0.1
 */
class ChartQueryTransHandler extends QueryRequestTransHandler {
    
    protected ChartQueryTransHandler() {
    }
    ...
    boolean isSupportedQueryStrategy(QueryStrategy queryStrategy) {
        return QueryStrategy.CHART_QUERY == queryStrategy;
    }
