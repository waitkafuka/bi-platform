...
public class QueryDataResource {
    ...
    public String queryVM(@PathVariable("reportId") String reportId, HttpServletRequest request,
        ...
        String jsBefore = "<script type='text/javascript'>" + "\r\n"
        ...
        builder.append("<link rel='stylesheet' href='/report-ui/asset-d/ditry/dev/css/-di-product-min.css'/>");
        builder.append("</head>");
        builder.append("<body>");
        builder.append(vm);
        builder.append(jsBefore);
        
        builder.append("<script src='/report-ui/asset-d/ditry/dev/-di-product-min.js'>");
